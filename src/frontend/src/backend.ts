...
import type { Category as _Category, Inquiry as _Inquiry, InquiryResult as _InquiryResult, InquirySubmission as _InquirySubmission, Product as _Product } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: InquirySubmission): Promise<InquiryResult> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(to_candid_InquirySubmission_n13(this._uploadFile, this._downloadFile, arg0));
                return from_candid_InquiryResult_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_InquiryResult_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InquiryResult): InquiryResult {
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "school" in value ? Category.school : "college" in value ? Category.college : value;
}
...
function to_candid_InquirySubmission_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InquirySubmission): _InquirySubmission {
